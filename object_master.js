...
//an array of pokémon objects where the id is evenly divisible by 3 -- .filter
const filteredPokémon = pokémon.filter((pokemon) => pokemon.id % 3 === 0);
console.log(filteredPokémon);
